  ...
  If OpenWindow(#Window_00, 436, 106, 402, 400, dimLanguageItems(1), #PB_Window_SystemMenu|#PB_Window_TitleBar|#PB_Window_MinimizeGadget|#PB_Window_ScreenCentered)
    PanelGadget(#Panel_00, 5, 5, 390, 390)
        ...
        PanelGadget(#Panel_01, 5, 30, 375, 325)
          ;{ Options
            AddGadgetItem(#Panel_01, -1, dimLanguageItems(4))
              Frame3DGadget(#Frame3D_03, 5, 5, 355, 70, dimLanguageItems(5))
              ...
              TextGadget(#Text_07, 5, 85, 80, 15, dimLanguageItems(19))
              StringGadget(#String_05, 100, 85, 260, 20, "")
              TextGadget(#Text_08, 5, 110, 80, 15, dimLanguageItems(12))
              StringGadget(#String_06, 100, 110, 260, 20, "")
              TextGadget(#Text_09, 5, 135, 90, 15, dimLanguageItems(16))
              StringGadget(#String_07, 100, 135, 195, 20, "")
              ButtonGadget(#Button_19, 300, 135, 60, 20, dimLanguageItems(14))
      ...
      ;{ Create an userlib from PB
        ...
        PanelGadget(#Panel_02, 5, 30, 375, 325)
          ;{ Options
            AddGadgetItem(#Panel_02, -1, dimLanguageItems(4))
              Frame3DGadget(#Frame3D_05, 5, 5, 355, 90, dimLanguageItems(5))
                CheckBoxGadget(#CheckBox_05, 10, 20, 170, 20, dimLanguageItems(6))
                CheckBoxGadget(#CheckBox_06, 180, 20, 170, 20, dimLanguageItems(7))
                CheckBoxGadget(#CheckBox_07, 10, 45, 170, 20, dimLanguageItems(8))
                CheckBoxGadget(#CheckBox_08, 180, 45, 170, 20, dimLanguageItems(9))
                CheckBoxGadget(#CheckBox_09, 10, 70, 170, 20, dimLanguageItems(10))
                CheckBoxGadget(#CheckBox_10, 180, 70, 170, 20,dimLanguageItems(11))
              TextGadget(#Text_10, 5, 105, 90, 15, dimLanguageItems(12))
              StringGadget(#String_10, 100, 100, 260, 20, "")
              TextGadget(#Text_11, 5, 130, 90, 15, dimLanguageItems(16))
              StringGadget(#String_11, 100, 125, 195, 20, "")
              ButtonGadget(#Button_13, 300, 125, 60, 20, dimLanguageItems(14))
              TextGadget(#Text_12, 5, 155, 90, 15, dimLanguageItems(15))
              StringGadget(#String_12, 100, 150, 195, 20, "")
              ButtonGadget(#Button_14, 300, 150, 60, 20, dimLanguageItems(14))
              TextGadget(#Text_13, 5, 180, 90, 15, dimLanguageItems(17))
              ComboBoxGadget(#ComboBox_04, 100, 175, 260, 25)
